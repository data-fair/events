...
describe('identities webhooks', () => {
  ...
  it('should update recipient and sender name', async () => {
    ...
    await axAno.post('/api/v1/identities/user/user1', { name: 'New name' }, { params: { key: 'SECRET_IDENTITIES' } })
  ...
  it('should remove deprecated private subscriptions', async () => {
    ...
    await axAno.post('/api/v1/identities/user/user1', { name: 'New name', organizations: [{ id: 'orga2', role: 'user' }] }, { params: { key: 'SECRET_IDENTITIES' } })
    ...
    await axAno.post('/api/v1/identities/user/user1', { name: 'New name', organizations: [{ id: 'orga2', role: 'user', department: 'dep2' }] }, { params: { key: 'SECRET_IDENTITIES' } })
    ...
    await axAno.post('/api/v1/identities/user/admin1', { name: 'New name', organizations: [{ id: 'orga1', role: 'user' }] }, { params: { key: 'SECRET_IDENTITIES' } })
